...
import { Shield, CheckCircle, Globe, Mail, ArrowRight, Star } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Verify if email domains can receive emails through comprehensive MX record analysis"
    },
    {
      icon: Shield,
      title: "SPF & DMARC Validation",
      description: "Ensure domains are properly configured to prevent spoofing and maintain security"
    },
    {
      icon: CheckCircle,
      title: "Disposable Email Detection",
      description: "Detect temporary or throwaway email domains to maintain data quality"
    },
    {
      icon: Globe,
      title: "GeoLocation Lookup",
      description: "Get IP location of MX servers including country, region, and city information"
    }
  ];
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          background: `radial-gradient(circle at 50% ${50 + scrollY * 0.1}%, hsl(var(--primary) / 0.1) 0%, transparent 50%)`
        }}
      />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 scroll-reveal">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4 glow-text">
              If you're running a newsletter, an e-commerce, a SaaS, or marketing campaigns, EmailValidator is for you.
            </h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {features.map((feature, index) => (
              <div key={index} className="card-gradient rounded-lg p-6 hover-glow scroll-reveal glow-border">
        ...
        <div className="max-w-4xl mx-auto text-center scroll-reveal">
          <div className="card-gradient rounded-2xl p-12 glow-border">
            ...
            <blockquote className="text-2xl font-medium mb-6 leading-relaxed">
              "EmailValidator delivers all we need in an email validation service: top security, 
              scalability, performance, and extensive integrations"
            </blockquote>
            <cite className="text-muted-foreground">A happy customer, probably</cite>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="relative z-10 py-20 px-6">
        <div className="max-w-2xl mx-auto text-center scroll-reveal">
          ...
          <p className="text-muted-foreground mb-8 text-lg">
            Join thousands of developers and businesses who trust EmailValidator for their email validation needs.
          </p>
          <Button 
            onClick={() => navigate("/check")}
            size="lg"
